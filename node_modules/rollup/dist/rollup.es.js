/*
	Rollup.js v0.39.2
	Fri Dec 30 2016 12:43:33 GMT-0500 (EST) - commit a00d3916c9e5b3d305cb2c628769ce4f86ada69c
...
Module.prototype.addImport = function addImport ( node ) {
	...
	node.specifiers.forEach( function (specifier) {
		...
		if ( this$1.imports[ localName ] ) {
			...
			err.file = this$1.id;
			err.loc = locate( this$1.code, specifier.start, { offsetLine: 1 });
			throw err;
		}
...
function getGlobalNameMaker ( globals, bundle ) {
